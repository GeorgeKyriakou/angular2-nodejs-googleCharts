...
var GetlogService = (function () {
    function GetlogService(http) {
        this.http = http;
    }
    GetlogService.prototype.getLogs = function () {
        return this.http.get('http://localhost:3000/service/log')
            .map(function (res) { return res.json(); });
    };
    GetlogService.prototype.getSomeLogs = function (selected) {
